...
public class ImageViewAnimationHelper {
     ...
     */
    public ImageViewAnimationHelper(Context context, LinearLayout imageView, float moveNum, float lineWithdp) {
    ...
    private void init() {
        ...
        //每段间隔距离
//        float surplus = context.getResources().getDisplayMetrics().widthPixels ;
        distance = 0;
